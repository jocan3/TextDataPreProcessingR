...
queryStr = paste("Insert into datasetrepresentation(dataset,representation,description,status) values(",datasetId,",",representation,",'",description," File:Train','running');",sep = "")
...
queryStr = paste("Insert into datasetrepresentation(dataset,representation,description,status) values(",datasetId,",",representation,",'",description," File:Test','running');",sep = "")
dbSendQuery(mydb, queryStr)
